...
function getWebGLContext(e) {
  ...
  o = !!i;
  o || (i = e.getContext("webgl", n) || e.getContext("experimental-webgl", n)),
  t = o ? (i.getExtension("EXT_color_buffer_float"), i.getExtension("OES_texture_float_linear")) : (r = i.getExtension("OES_texture_half_float"), i.getExtension("OES_texture_half_float_linear")),
  i.clearColor(0, 0, 0, 1);
  var a, l, u, c = o ? i.HALF_FLOAT: r.HALF_FLOAT_OES;
  return u = o ? (a = getSupportedFormat(i, i.RGBA16F, i.RGBA, c), l = getSupportedFormat(i, i.RG16F, i.RG, c), getSupportedFormat(i, i.R16F, i.RED, c)) : (a = getSupportedFormat(i, i.RGBA, i.RGBA, c), l = getSupportedFormat(i, i.RGBA, i.RGBA, c), getSupportedFormat(i, i.RGBA, i.RGBA, c)),
  {
    gl: i,
    ext: {
      formatRGBA: a,
...
ext.supportLinearFiltering || (config.DYE_RESOLUTION = 512, config.SHADING = !1, config.BLOOM = !1, config.SUNRAYS = !1);
...
function initBloomFramebuffers() {
  ...
  for (var i = bloomFramebuffers.length = 0; i < config.BLOOM_ITERATIONS; i++) {
    ...
    a = e.height >> i + 1;
    if (o < 2 || a < 2) break;
    var l = createFBO(o, a, t.internalFormat, t.format, r, n);
...
function createFBO(e, r, t, n, i, o) {
  ...
  return gl.bindFramebuffer(gl.FRAMEBUFFER, l),
...
function resizeDoubleFBO(e, r, t, n, i, o, a) {
  return e.width == r && e.height == t || (e.read = resizeFBO(e.read, r, t, n, i, o, a), e.write = createFBO(r, t, n, i, o, a), e.width = r, e.height = t, e.texelSizeX = 1 / r, e.texelSizeY = 1 / t),
  e
}
...
function step(e) {
  ...
  for (var r = 0; r < config.PRESSURE_ITERATIONS; r++) gl.uniform1i(pressureProgram.uniforms.uPressure, pressure.read.attach(1)),
  blit(pressure.write.fbo),
  pressure.swap();
...
function render(e) {
  ...
  config.SUNRAYS && (applySunrays(dye.read, dye.write, sunrays), blur(sunrays, sunraysTemp, 1)),
  null != e && config.TRANSPARENT ? gl.disable(gl.BLEND) : (gl.blendFunc(gl.ONE, gl.ONE_MINUS_SRC_ALPHA), gl.enable(gl.BLEND));
...
function blur(e, r, t) {
  blurProgram.bind();
  for (var n = 0; n < t; n++) gl.uniform2f(blurProgram.uniforms.texelSize, e.texelSizeX, 0),
...
function hashCode(e) {
  ...
  for (var r = 0,
  t = 0; t < e.length; t++) r = (r << 5) - r + e.charCodeAt(t),
  r |= 0;
  return r
}
...
function(e) {
  if (!switchPage || !switchPage.switched) for (var t = e.changedTouches,
  r = function(r) {
    var e = pointers.find(function(e) {
      return e.id == t[r].identifier
    });
